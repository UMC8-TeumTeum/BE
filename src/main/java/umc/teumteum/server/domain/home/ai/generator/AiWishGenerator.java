        ...
        "messages", List.of(
            Map.of("role", "system", "content",
                "너는 사용자의 취향에 맞게 활동을 추천하는 도우미다. 반드시 한국어로 답한다.\n" +
                    ...
                    "제목(title)은 20자 이내, 설명(content)은 100자 이내로 작성한다.\n" +
                    "제목은 행동을 나타내는 동사구(~하기, ~가기 등)로 시작해야 한다.\n" +
                    "설명은 활동의 구체적 분위기나 상황을 간단히 풀어써라.\n" +
                    "세 항목은 서로 의미가 명확히 달라야 하며, 비슷한 표현이나 동의어를 반복하지 마라.\n" +
